...
SpellcheckerFactory.prototype.getSpellChecker = function(lang){
  ...
  var success = spellchecker.setDictionary(lang, this.this.userDictPath || this.dictPath);
  if(!success && !spellchecker.isHunspell()) {
    spellchecker = new Spellchecker(true);
    success = spellchecker.setDictionary(lang, this.this.userDictPath || this.dictPath);
  }
